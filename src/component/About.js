    ...
    <div className='bg-[rgb(5,8,22)] relative overflow-x-hidden lm:min-h-[255vh] w-full min-h-[125vh] tb:min-h-[160vh] flex items-center justify-center' id='About'>
      <div className="w-[95%] h-[100vh] lm:h-[140vh] flex flex-col justify-center lm:items-center gap-20">
        ...
        <div  className="flex gap-14 tb:gap-8 w-[90%] px-[15vh] lm:min-h-[150vh] lm: tb:px-[8vh] mx-[4vw] a_container">
         ...
         <Tilt options={defaultOptions} > 
         <div className="flex flex-col border-2 border-orange-400 lm:w-[85vw] items-center justify-center tb:w-[30vw] tb:h-[48vh] w-[19vw] h-[45vh] rounded-[20px]">
          <img src={img_div2} className='w-[85px] h-[85px]' alt="" />
          <h1 className='text-xl font-bold'>DevOps</h1>
          </div>
          </Tilt>
          <Tilt options={defaultOptions} >
            <div className="flex border-2 border-orange-400 lm:w-[85vw] tb:w-[30vw] tb:h-[48vh]  flex-col items-center justify-center w-[19vw] h-[45vh] rounded-[20px]">
