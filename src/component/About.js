...
export default function About() {
  ...
  return (
    <div className='bg-[rgb(5,8,22)] lm:min-h-[230vh] w-full min-h-[125vh] tb:min-h-[160vh] flex items-center justify-center'>
      <div className="w-[95%] h-[100vh] lm:h-[135vh] flex flex-col justify-center gap-20">
        <div className="flex flex-col w-[75%] tb:w-[90%] lm:w-[85vw] px-[15vh] tb:px-[6vh] lm:py-[5vw] lm:px-[5vw]">
        <h1 className='text-xl text-gray-400 font-medium'>INTRODUCTION</h1>
        <h1 className='text-[5.5vw] font-extrabold'>Overview .</h1>
        <p className='text-xl text-white font-normal'>I'm a passionate individual learning and working with new technologies. I love solving real-world problems and learning along the way. I have currently explored the field of Devops, Frontend and Backend tools and technologies</p>
        </div>
        
        <div className="flex gap-14 tb:gap-8 w-[90%] px-[15vh] tb:px-[8vh] mx-[4vw] a_container">
