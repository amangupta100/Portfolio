...
export default function About() {
  ...
  return (
    <div className='bg-[rgb(5,8,22)] overflow-x-hidden lm:min-h-[236vh] w-full min-h-[125vh] tb:min-h-[160vh] flex items-center justify-center' id='About'>
      <div className="w-[95%] h-[100vh] lm:h-[140vh] flex flex-col justify-center gap-20">
        ...
        <h1 className='text-[5.5vw] font-bold lm:text-[7vw] '>Overview .</h1>
